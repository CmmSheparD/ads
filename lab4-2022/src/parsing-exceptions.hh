...
class OperatorExpectationUnsatisfied : public UnsatisfiedExpectation {
public:
    OperatorExpectationUnsatisfied(size_t pos)
        : UnsatisfiedExpectation("Operator was expected, but couldn't be found.", pos)
    {}
};
